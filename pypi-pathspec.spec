...
Source0  : https://files.pythonhosted.org/packages/03/45/41884de3da7c1012c729fc6fdad25d6b7906c69f5aaf4b23238ac8acfced/pathspec-0.10.0.tar.gz
...
%prep
%setup -q -n pathspec-0.10.0
cd %{_builddir}/pathspec-0.10.0
pushd ..
cp -a pathspec-0.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661967659
