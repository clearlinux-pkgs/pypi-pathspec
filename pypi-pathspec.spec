...
Source0  : https://files.pythonhosted.org/packages/95/60/d93628975242cc515ab2b8f5b2fc831d8be2eff32f5a1be4776d49305d13/pathspec-0.11.1.tar.gz
...
%prep
%setup -q -n pathspec-0.11.1
cd %{_builddir}/pathspec-0.11.1
pushd ..
cp -a pathspec-0.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678891302
